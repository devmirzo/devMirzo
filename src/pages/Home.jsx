...
export default function Home() {
  ...
  return (
    ...
    <section className="min-h-screen flex items-center pt-24 md:pt-32 pb-16 overflow-hidden bg-gradient-to-b from-[#f9f7ed] to-[#f3f1e6] dark:from-[#0f172a] dark:to-[#1e293b] relative transition-colors duration-500">
      ...
      <div className="absolute bottom-[-10%] left-[-5%] w-[400px] h-[400px] bg-[#2c3e63]/10 dark:bg-[#4f8cff]/5 rounded-full blur-[120px] -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-14 lg:gap-20 items-center relative z-10">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {titles[index] === "Humoyun Mirzo" ? (
                  ...
                  <span className="text-[#1f2937] dark:text-[#4f8cff]">
                    {titles[index]}
                  </span>
                )}
              </motion.h1>
          ...
          <div className="flex flex-wrap gap-6 items-center">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="p-4 text-[#2c3e63]/40 dark:text-[#f8fafc]/40 hover:text-[#4f8cff] dark:hover:text-[#4f8cff] hover:bg-white dark:hover:bg-[#1e293b] rounded-2xl shadow-sm border border-[#2c3e63]/5 dark:border-white/5 transition"
              >
                <Github size={24} />
              </a>
              <a
        ...
        >
          <div className="relative w-full max-w-[440px] aspect-[4/5] group">
            ...
            {/* Decorative Layer */}
            <div className="absolute inset-0 bg-[#2c3e63] dark:bg-[#4f8cff] rounded-[3rem] rotate-6 group-hover:rotate-3 transition-transform duration-700 shadow-2xl shadow-[#2c3e63]/30 dark:shadow-[#4f8cff]/20" />

            {/* Image */}
            <div className="absolute inset-0 bg-[#1f2937] rounded-[3rem] overflow-hidden border-8 border-white dark:border-[#1e293b] shadow-2xl">
              <img
                src="/my-picture.png"
                alt="Humoyun Mirzo"
            ...
            <motion.div
              ...
              className="absolute -right-10 top-[18%] bg-white dark:bg-[#1e293b] p-4 rounded-2xl shadow-xl border border-[#4f8cff]/20 hidden lg:block"
            >
              <div className="flex items-center gap-3">
            ...
            <motion.div
              ...
              className="absolute -left-12 bottom-16 bg-[#2c3e63] dark:bg-[#1e293b] p-4 rounded-2xl shadow-xl hidden lg:block border border-white/5"
            >
              <div className="flex items-center gap-3">
